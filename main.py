...
parser.add_argument('--dir_path', default='../data/detect_imgs/')
parser.add_argument('--arch', default='densenet201')
...
parser.add_argument('--new_length', default=384, type=int)
parser.add_argument('--new_width', default=384, type=int)
...
def main():
    ...
    optimizer = torch.optim.SGD([{'params': model.module.features.parameters()},
                                {'params': model.module.classifier_func.parameters(), 'lr': args.lr*10}],
                                lr=args.lr,
...
def build_model():
    ...
    model = getattr(densenet, model_name)(pretrained=True, num_classes=128)
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target, _) in enumerate(train_loader):
        ...
        # class_label_var = torch.autograd.Variable(class_label)
        ...
        if i % args.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                  ...
                  'Prec {top1.val:.3f} ({top1.avg:.3f})\t'.format(
                   ...
                   data_time=data_time, loss=losses, loss1=losses1, loss2=losses2, top1=top1))
